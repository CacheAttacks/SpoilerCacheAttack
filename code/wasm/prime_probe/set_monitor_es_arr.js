...
//example from https://kapadia.github.io/emscripten/2013/09/13/emscripten-pointers-and-pointers.html
    ...
    Module['asm']._set_monitored_es_arr(Module['appStatePtr'], dataPtr, listEsArr.length);
    var result = new Int32Array(dataHeap.buffer, dataHeap.byteOffset, listEsInt32Arr.length);
    ...
    console.log("Module['appStatePtr'] is null!");
  }