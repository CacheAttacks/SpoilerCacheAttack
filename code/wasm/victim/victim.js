...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'victim.wast';
  var wasmBinaryFile = 'victim.wasm';
  var asmjsCodeFile = 'victim.temp.asm.js';
...
var real__bla = asm["_bla"]; asm["_bla"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__bla.apply(null, arguments);
};
...
var real__read_mem = asm["_read_mem"]; asm["_read_mem"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__read_mem.apply(null, arguments);
};
...
var _bla = Module["_bla"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_bla"].apply(null, arguments) };
...
var _read_mem = Module["_read_mem"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_read_mem"].apply(null, arguments) };
