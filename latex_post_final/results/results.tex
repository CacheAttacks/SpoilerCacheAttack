...
Die Zahl \textit{random_num} wird an die Funktion mpp_make_prime in der Datei mpprime.c übergeben (siehe Pseudocode \ref{alg:makePrimeGenerationNSS}).
...
Angenommen, die zu \text{\textit{primes_tab}}[0-7] gehörige Cache-Line wird mittels Prime-and-Probe überwacht, dann können nach Start des Siebvorgangs 8 Zugriffe mit jeweils etwa 4800 Taktzyklen (mittlere Dauer einer Iteration von \textit{mpp_sieve} bei RSA 2048) Abstand gemessen werden.
%(besser?)
...
%\label{tbl:bitLengthSmallPrime}
%\begin{tabular}{c|cccc}
%Bitlänge Primzahl     & 1024 & 1536 & 2048 & 4096 \\
%E(Bitlänge $\text{\textit{small_prime}}_i$) & 5,3   & 142  & 189  & 379 
%\end{tabular}
%\end{table}
...
\toprule
\multicolumn{1}{c}{Bitlänge Primzahl}          & \multicolumn{1}{c}{E(Anzahl Iterationen)}  \\
\midrule
1024                       &  95                   \\
1536                       & 142                   \\
2048                       & 189                   \\
...
\begin{tabular}{cccc}
\toprule
Funktion       & Startadresse & Endadresse & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Differenz\\(Größe der Funktion)\end{tabular}} \\
\midrule
...
\begin{table}[h]
\caption{RSA-2048 Performance-Degradation-Attack mittels Prime-Spam auf mehrere Cache-Lines. Für die Auflösung der Cache-Line IDs siehe Tabelle \ref{tbl:PerformanceDegShift}. Die 2. Spalte gibt der Übersicht halber nur die Funktionen innerhalb der Cache-Lines (1. Spalte) an, welche bei der Berechnung der Shift-Operation relevant sind. So wird etwa die Funktion \textit{s_mp_free} in der ersten Zeile nicht aufgeführt, obwohl die Cache-Line $V1_1$ Teile des Codes von \textit{s_mp_free} enthält. Aus Platzgründen wurden die Funktionsnamen gekürzt, wobei für den vollen Funktionsnamen $*$ mit \textit{s_mp_}  zu substituieren ist.}
