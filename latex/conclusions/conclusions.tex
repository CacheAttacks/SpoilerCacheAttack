...
Der Angriff nutzt die spezifische Eigenschaft der Intel-Architektur aus, dass der L3-Cache zwischen den Kernen geteilt und inklusiv ist sowie LRU oder eine vergleichbare Eviciton-Policy verwendet. 
...
Zudem ist nicht jeder Angriff ein Erfolg, so hat beispielsweise der native Angriff auf die RSA-Keygenerierung \cite{RSAKeyGeneration2} hat nur eine Erfolgsquote von etwa 28\%.

Diesen Einschränkungen unterliegt auch die Leakage mit den Unklarheiten im Bezug auf die praktische Anwendung bei der RSA-Primzahlgenerierung, wobei praktische Szenarien denkbar sind. 

So werden die E-Mail-Zertifikate der neuen Studierenden der Universität zu Lübeck zum Beginn des Wintersemesters in einem Einführungskurs lokal erzeugt. 
Eine Angreiferin könnte versuchen die Website zu manipulieren, welche die Zertifikatsgenerierung beschreibt.
Da der Zeitraum indem die Zertifikatsgenerierung stattfindet, bekannt sowie eingegrenzt ist und es viele potenzielle Opfer gibt, kann der Angriff sich hier auszahlen.
...
In Abschnitt \ref{relatedWorkHyperthreading} wurde beschrieben, dass erweiterte Möglichkeiten bestehen wenn der Angriffsprozess auf demselben physischen Kern wie der Opferprozess läuft und im Browser der ausführende Kern nicht festgelegt werden kann.
...
Jedoch bietet der Markt mobiler Geräte im Vergleich zum Desktop und Notebook-Bereich mehr Prozessorhersteller mit signifikanten Marktanteil, welche über unterschiedliche Mikroarchitekturen verfügen.
...
\todo{Eigene Section Gegenmaßnahmen einfügen?} 
...
Zudem lässt sich bei vielen Systemen anhand der Lautstärke die Last des Systems ablesen. 
...
Da der Angriff Javascript benötigt und in einem praktischen Szenario vorzugsweise über Werbeanzeigen ausgeliefert wird, stellen die ohnehin empfehlenswerten Ad- und Javascriptblocker eine effektive Gegenmaßnahme dar.
