...
%
% == modified for ITS by Jan Wichelmann
...
\usepackage[ngerman]{todonotes}              % Make TODO-notes
% This package is used for the following spacing options
\usepackage{setspace}
\usepackage[shortlabels]{enumitem}	% Andere Nummerierungsstile in Aufzählungen
\usepackage{hhline}					% Tabellenlinien
...
% Unused references (for debugging)
%\usepackage{refcheck}

% German bibliography (if needed)
%_\usepackage{bibgerm}
...
\lstset{
  ...
  keywordstyle=\bfseries\color{oceangreen},
