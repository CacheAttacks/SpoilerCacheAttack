...
TODO assembler offsets der funktionsadressen\\
TODO aufrufe naheligender Funktionen tracken um zu bewerten welche Adresse günstiger für eine Überwachung ist

Es bestehen somit mehrere Möglichkeiten die Ausführung der Shfit-Operation zu erkennen, wobei sich manche im Callstack befindliche Funktionen weniger eigenen, da sie auch an anderer Stelle aufgerufen werden.
So wird etwa die Funktion $s\_mp\_clamp$ auch in der zuständigen Subtraktionroutine verwendet, sodass eine Überwachung dieser für die Shift-Operation falsche Ergebnisse liefern würde.
...
Am besten geeignet für eine Überwachung scheint hier der Code für die Funktion $mp\_sub$.
/TODO check nahliegende Funks
...
In der Tabelle \ref{ShiftSubCycles} ist die durchschnittlichen der Zyklen für beide Funktion bei verschiedenen Schlüssellängen angegeben. Zum Vergleich wurde die Dauer der gesamten GCD-Funktion hinzugefügt.
...
TODO Zuordnen von adressen im code zu eviction set mittels page offsets\\
