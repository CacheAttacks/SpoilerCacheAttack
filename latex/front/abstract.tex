...
In 2015 it was shown that browser-based attacks are even possible if the victim has only visited a website \cite{TheSpyInTheSandbox}.
...
The attack neither requires an exploit in the browser nor a user's negligent behavior.%(amerikanische Schreibweise!!).
