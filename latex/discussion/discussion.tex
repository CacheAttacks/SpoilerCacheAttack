...
Abschnitt \ref{MoreIsBetter} und \ref{MemoryLocking} haben gezeigt, dass die (???) Prim-Spam und Memory-Locking auch mit mehreren Threads nicht ausreichen, um einen Teil der Primzahlen zu rekonstruieren.
