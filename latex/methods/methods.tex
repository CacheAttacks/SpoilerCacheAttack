...
Die Zählvariable soll hier eine Größe von 32 Bit haben, weshalb abschließend ein \lstinline{Uint32Array} definiert wird, dessen Inhalt auf den SharedArrayBuffer referenziert. 
