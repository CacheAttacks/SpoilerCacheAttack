...
Die Ergenisse in Tabelle \ref{} zeigen eine deutliche Verbesserung der Laufzeit gegenüber dem alten Algorithmus.
...
Somit würde nicht nur die Performance ansteigen, sondern der Algorithmus auch weniger Fehler produzieren.
Zurzeit bietet Webassembly kein Multithreading \cite{WebassemblyThreads} und da die gesamte Eviction-Set-Suche in Webassembly implementiert ist, lässt sich dieser Ansatz zurzeit nicht testen.
Im Gegensatz dazu 
